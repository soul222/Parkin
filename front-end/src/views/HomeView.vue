<template>
  <div class="space-y-5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      <div class="stat-card">
        ...
        <template v-if="isLoadingData">
          <SkeletonShimmer width="60%" height="36px" class="mb-2" />
          <SkeletonShimmer width="100%" height="6px" class="mb-2" borderRadius="999px" />
          <div class="flex justify-between mt-2">
            <SkeletonShimmer width="30%" height="16px" />
            <SkeletonShimmer width="40%" height="16px" />
          </div>
        </template>
        <template v-else>
    ...
    <div class="card">
      ...
      <div v-if="isLoadingData" class="w-full h-[280px] p-2">
        <SkeletonShimmer width="100%" height="100%" borderRadius="8px" />
      </div>
      <div v-show="!isLoadingData" class="relative" style="height: 280px;">
